...
%
  ...
  some phases of the optimizing Javascript compiler's (Crankshaft's)
...
%
  ...
  the native thread stack at runtime.
%
}
...
\cvitem{}{%
  {\small Most of the production code I've written is in \textbf{C++}
    and \textbf{C}.  I have used \textbf{Haskell} in non-trivial
    personal projects and am familiar with \textbf{Java},
    \textbf{Agda} and \textbf{Python}.}}  {}

\largegap
\section{Education}

\tinygap
\vbox{\cventry{2008--2013}{Master of Science, Bachelor of Science}{Indian Institute of Technology Kharagpur}{}{}{
