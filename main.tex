...
%
  I was an intern on the \textbf{V8 / Chrome} and worked on moving
  some of the optimization phases run by optimizing Javascript
  compiler to a dedicated compiler thread.
%
}
...
%
  I implemented support for \textbf{segmented stacks} on the x86
  platform for \textbf{llvm}. This feature allows llvm generated code
  to allocate stack space incrementally instead of pessimistically
  allocating a large chunk at thread creation.
%
}
...
\cvitem{}{%
  {\small My love for interesting programming challenges trumps my
    love for interesting programming languages; and for this reason
    most of the production code I've written is in \textbf{C++} and
    \textbf{C}.  I have used \textbf{Haskell} in non-trivial personal
    projects and am familiar with \textbf{Java}, \textbf{Agda} and
    \textbf{Python}.}}  {}
